...
<h2 class="text-xl font-semibold text-white-800 mb-2 text-center"></h2>
...
    </div>
    ...
    <div class="flex justify-start mb-4">
        <a href="<?php echo e(route('mitra.create')); ?>"
            ...
            <tbody>
                ...
                <tr class="hover:bg-pink-50">
                    ...
                    <td class="border px-3 py-2 text-center flex justify-center gap-3">
                        <a href="<?php echo e(route('mitra.edit', $item->id)); ?>"
                        ...
                        <form action="<?php echo e(route('mitra.destroy', $item->id)); ?>" method="POST"
                ...
                <tr>
                    <td colspan="6" class="border px-3 py-4 text-center text-gray-500">Tidak ada data</td>
                </tr>
                <?php endif; ?>
            </tbody>
        </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ternakpro2\resources\views/setting/mitra/index.blade.php ENDPATH**/ ?>