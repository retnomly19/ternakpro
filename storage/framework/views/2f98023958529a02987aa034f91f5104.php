...
    </div>
    ...
    <!-- Filter & Search -->
<form method="GET" action="<?php echo e(route('ternak.index')); ?>" 
    ...
    <div>
        ...
        <select name="filter_kategori" id="filter_kategori" 
            ...
            <?php $__currentLoopData = ['Domba','Kambing','Sapi','Kerbau','Ayam','Kuda']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($cat); ?>" <?php if(request('filter_kategori') == $cat): echo 'selected'; endif; ?>><?php echo e($cat); ?></option>
    ...
    <div>
        ...
        <select name="filter_lokasi" id="filter_lokasi" 
            class="border rounded-md px-2 py-1.5 min-w-[120px] shadow-sm focus:ring focus:ring-blue-200">
            <option value="">-- Semua --</option>
            <?php $__currentLoopData = ['Kandang A','Kandang B','Kandang C','Kandang D','Kandang E','Kandang F','Kandang G','Kandang H']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($loc); ?>" <?php if(request('filter_lokasi') == $loc): echo 'selected'; endif; ?>><?php echo e($loc); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
    ...
    <div>
        ...
        <input type="number" name="filter_umur" id="filter_umur" value="<?php echo e(request('filter_umur')); ?>"
    ...
    <div>
        ...
        <select name="filter_jenis_kelamin" id="filter_jenis_kelamin" 
            class="border rounded-md px-2 py-1.5 min-w-[120px] shadow-sm focus:ring focus:ring-blue-200">
            <option value="">-- Semua --</option>
            <option value="Jantan" <?php if(request('filter_jenis_kelamin')=='Jantan'): echo 'selected'; endif; ?>>Jantan</option>
            <option value="Betina" <?php if(request('filter_jenis_kelamin')=='Betina'): echo 'selected'; endif; ?>>Betina</option>
        </select>
    </div>
    ...
    <div>
        ...
        <select name="filter_kondisi" id="filter_kondisi" 
            class="border rounded-md px-2 py-1.5 min-w-[120px] shadow-sm focus:ring focus:ring-blue-200">
            <option value="">-- Semua --</option>
            <option value="Sehat" <?php if(request('filter_kondisi')=='Sehat'): echo 'selected'; endif; ?>>Sehat</option>
            <option value="Sakit" <?php if(request('filter_kondisi')=='Sakit'): echo 'selected'; endif; ?>>Sakit</option>
        </select>
    </div>
    ...
    <!-- Tombol Reset -->
    <div>
        <a href="<?php echo e(route('ternak.index')); ?>" class="text-gray-500 hover:underline text-xs">Reset</a>
    </div>
</form>

<!-- Tambah Data -->
<div class="mb-4">
    <a href="<?php echo e(route('ternak.create')); ?>"
...
<div class="overflow-x-auto bg-white rounded-lg shadow">
    <table class="min-w-full divide-y divide-gray-200 table-auto text-xs">
        ...
        <tbody class="divide-y divide-gray-100">
            <?php $__empty_1 = true; $__currentLoopData = $ternak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-gray-50">
                    <td class="px-2 py-1 text-center">
                        <?php echo e($loop->iteration + ($ternak->currentPage() - 1) * $ternak->perPage()); ?>

                    </td>
                    <td class="px-2 py-1">
                        <?php if($item->foto): ?>
                            <img src="<?php echo e(asset('storage/' . $item->foto)); ?>" alt="Foto Ternak" class="w-10 h-10 object-cover rounded-md">
                        <?php else: ?>
                            <span class="text-gray-400">Tidak ada</span>
                        <?php endif; ?>
                    </td>
                    <td class="px-2 py-1"><?php echo e($item->id_ternak); ?></td>
                    <td class="px-2 py-1"><?php echo e($item->kategori); ?></td>
                    <td class="px-2 py-1"><?php echo e($item->jenis); ?></td>
                    <td class="px-2 py-1"><?php echo e($item->lokasi); ?></td>
                    <td class="px-2 py-1"><?php echo e($item->umur); ?></td>
                    <td class="px-2 py-1"><?php echo e($item->jenis_kelamin); ?></td>
                    <td class="px-2 py-1">Rp <?php echo e(number_format($item->harga_beli, 2, ',', '.')); ?></td>
                    <td class="px-2 py-1"><?php echo e($item->kondisi); ?></td>
                    <td class="px-2 py-1"><?php echo e(\Carbon\Carbon::parse($item->tanggal_masuk)->format('d/m/Y')); ?></td>
                    <td class="px-2 py-1"><?php echo e($item->vaksinasi ?? '-'); ?></td>
                    <td class="px-2 py-1"><?php echo e($item->penanggung_jawab ?? '-'); ?></td>
                    <td class="px-2 py-1"><?php echo e($item->pemasok->nama ?? '-'); ?></td>
                    <td class="px-2 py-1"><?php echo e($item->cek_medis_terakhir ? \Carbon\Carbon::parse($item->cek_medis_terakhir)->format('d/m/Y') : '-'); ?></td>
                    <td class="px-2 py-1 text-center">
                        <div class="flex justify-center space-x-2">
                            <!-- Edit -->
<a href="<?php echo e(route('ternak.edit', $item->id_ternak)); ?>" 
   class="text-blue-600 hover:text-blue-800" title="Edit">
    <svg xmlns="http://www.w3.org/2000/svg" 
        ...
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
              d="M15.232 5.232l3.536 3.536M4 20h4l10.293-10.293a1 1 0 00-1.414-1.414L6.586 18.586A1 1 0 006 19.293V20z" />
                            ...
                            <!-- Hapus -->
                            <form action="<?php echo e(route('ternak.destroy', $item->id_ternak)); ?>" method="POST" class="inline" onsubmit="return confirm('Yakin hapus data ini?');">
                                <?php echo csrf_field(); ?>
    ...
    <div class="mt-4">
        <?php echo e($ternak->withQueryString()->links()); ?>

    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ternakpro2\resources\views/ternak/index.blade.php ENDPATH**/ ?>