            ...
            <tbody>
                ...
                <tr class="hover:bg-pink-50">
                    ...
                    <td class="border px-3 py-2 text-center flex justify-center gap-3">
                        ...
                        <form action="<?php echo e(route('pelanggan.destroy', $item->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ternakpro2\resources\views/setting/pelanggan/index.blade.php ENDPATH**/ ?>