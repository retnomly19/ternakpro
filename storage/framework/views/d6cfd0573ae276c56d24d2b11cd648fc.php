...
<h2 class="text-xl sm:text-2xl font-bold text-white flex items-center justify-start gap-2">
    ...
    Profil <?php echo e(Auth::user()->role === 'admin' ? 'Admin' : 'User'); ?>
...
<div class="max-w-sm mx-auto bg-white rounded-xl shadow-lg p-6 text-center">
    ...
    <p class="text-gray-600 text-sm mb-4"><?php echo e($user->email); ?></p>
    ...
    <div class="space-y-3 text-sm text-left">
        <div class="flex items-center justify-between">
            ...
            <span class="font-medium"><?php echo e($user->job ?? '-'); ?></span>
        </div>
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-2 text-gray-500">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2"
            ...
            <span class="font-medium"><?php echo e($user->telepon ?? '-'); ?></span>
        </div>
    </div>
...
<?php echo $__env->make(Auth::user()->role === 'admin' ? 'layouts.app_admin' : 'layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ternakpro2\resources\views/profile/index.blade.php ENDPATH**/ ?>