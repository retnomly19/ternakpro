...
<div class="min-h-screen flex">
    ...
    <aside class="w-64 bg-blue-700 text-white shadow-lg flex flex-col">
        ...
        <nav class="flex-1 px-3 py-4">
            <ul class="space-y-2">
                <!-- Dashboard -->
                <li>
                    <a href="<?php echo e(route('dashboard')); ?>" title="Lihat ringkasan sistem"
                       class="flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-blue-600 transition
                              <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-800 font-semibold' : ''); ?>">
                ...
                <!-- Data Ternak -->
                <li>
                    <a href="<?php echo e(route('ternak.index')); ?>" title="Kelola data semua ternak"
                       class="flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-blue-600 transition
                              <?php echo e(request()->routeIs('ternak.*') ? 'bg-blue-800 font-semibold' : ''); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Aktivitas -->
                <li>
                    <a href="<?php echo e(route('aktivitas.index')); ?>" title="Pantau aktivitas harian ternak"
                       class="flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-blue-600 transition
                              <?php echo e(request()->routeIs('aktivitas.*') ? 'bg-blue-800 font-semibold' : ''); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Jenis Aktivitas -->
                <li>
                    <a href="<?php echo e(route('jenis_aktivitas.index')); ?>" title="Kelola jenis aktivitas ternak"
                       class="flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-blue-600 transition
                              <?php echo e(request()->routeIs('jenis_aktivitas.*') ? 'bg-blue-800 font-semibold' : ''); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Data Kandang -->
                <li>
                    <a href="<?php echo e(route('kandang.index')); ?>" title="Data kandang dan lokasi"
                       class="flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-blue-600 transition
                              <?php echo e(request()->routeIs('kandang.*') ? 'bg-blue-800 font-semibold' : ''); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Kategori Ternak -->
                <li>
                    <a href="<?php echo e(route('kategori_ternak.index')); ?>" title="Kategori hewan ternak"
                       class="flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-blue-600 transition
                              <?php echo e(request()->routeIs('kategori_ternak.*') ? 'bg-blue-800 font-semibold' : ''); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Penjualan Ternak -->
                <li>
                    <a href="<?php echo e(route('penjualan_ternak.index')); ?>" title="Data transaksi penjualan ternak"
                       class="flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-blue-600 transition
                              <?php echo e(request()->routeIs('penjualan.*') ? 'bg-blue-800 font-semibold' : ''); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Laporan -->
                <li x-data="{ open: <?php echo e(request()->routeIs('laporan.*') ? 'true' : 'false'); ?> }">
                    ...
                    <ul x-show="open" x-transition class="mt-1 pl-6 space-y-1 text-blue-100">
                        <li><a href="<?php echo e(route('laporan.aktivitas')); ?>" title="Laporan aktivitas" class="block px-2 py-1 rounded hover:bg-blue-600">Aktivitas</a></li>
                        <li><a href="<?php echo e(route('laporan.persediaan')); ?>" title="Laporan persediaan" class="block px-2 py-1 rounded hover:bg-blue-600">Persediaan</a></li>
                        <li><a href="<?php echo e(route('laporan.penjualan')); ?>" title="Laporan penjualan" class="block px-2 py-1 rounded hover:bg-blue-600">Penjualan</a></li>
                        <li><a href="<?php echo e(route('laporan.kematian')); ?>" title="Laporan kematian ternak" class="block px-2 py-1 rounded hover:bg-blue-600">Kematian</a></li>
                    </ul>
                </li>
                ...
                <li x-data="{ open: false }">
                    ...
                    <ul x-show="open" x-transition class="mt-1 pl-6 space-y-1 text-blue-100">
                        <li><a href="<?php echo e(route('pemasok.index')); ?>" title="Data pemasok" class="block px-2 py-1 rounded hover:bg-blue-600">Pemasok</a></li>
                        <li><a href="<?php echo e(route('mitra.index')); ?>" title="Data mitra" class="block px-2 py-1 rounded hover:bg-blue-600">Mitra</a></li>
                        <li><a href="<?php echo e(route('pelanggan.index')); ?>" title="Data pelanggan" class="block px-2 py-1 rounded hover:bg-blue-600">Pelanggan</a></li>
                    </ul>
                </li>
    ...
    <h1 class="mx-auto text-lg font-bold tracking-wide"><?php echo $__env->yieldContent('header'); ?></h1>
    <div class="ml-auto flex items-center space-x-3">
        <a href="<?php echo e(route('profile.index')); ?>" class="flex items-center gap-2 hover:opacity-90">
...
</html><?php /**PATH C:\laragon\www\ternakpro2\resources\views/layouts/app.blade.php ENDPATH**/ ?>