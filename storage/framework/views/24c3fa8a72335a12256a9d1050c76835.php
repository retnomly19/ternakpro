...
<div class="max-w-md mx-auto bg-white p-6 rounded-xl shadow-lg">
    ...
    <form action="<?php echo e(route('profile.update.custom')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
        <?php echo csrf_field(); ?>
        ...
        <div class="relative">
            <label class="block text-sm font-medium text-gray-600 mb-1"><?php echo e($field['label']); ?></label>
            <div class="relative">
                <span class="absolute inset-y-0 left-3 flex items-center text-gray-400">
                    <?php if($field['icon'] === 'user'): ?>
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
                             viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round"
                             d="M5.121 17.804A13.937 13.937 0 0112 15c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                    <?php elseif($field['icon'] === 'mail'): ?>
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
                             viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round"
                             d="M16 12H8m0 0l-4 4m4-4l-4-4m12 4h-4m0 0l4 4m-4-4l4-4" /></svg>
                    <?php elseif($field['icon'] === 'briefcase'): ?>
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
                             viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round"
                             d="M6 7V6a2 2 0 012-2h8a2 2 0 012 2v1m-12 0h12m-12 0v10a2 2 0 002 2h8a2 2 0 002-2V7" /></svg>
                    <?php elseif($field['icon'] === 'telepon'): ?>
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
                             viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round"
                ...
                <input type="<?php echo e($field['type']); ?>"
                       ...
                       value="<?php echo e(old($field['name'], Auth::user()->{$field['name']})); ?>"
...
<?php echo $__env->make(Auth::user()->role === 'admin' ? 'layouts.app_admin' : 'layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ternakpro2\resources\views/profile/edit.blade.php ENDPATH**/ ?>