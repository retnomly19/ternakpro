    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-5 space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-gradient-to-br from-blue-600 to-indigo-700 text-white rounded-2xl shadow-xl p-6 
                ...
                <div>
                    <div class="text-4xl font-extrabold drop-shadow-sm"><?php echo e($jumlahTernak ?? 0); ?></div>
            ...
            <div class="bg-gradient-to-br from-green-600 to-teal-700 text-white rounded-2xl shadow-xl p-6 
                ...
                <div>
                    <div class="text-4xl font-extrabold drop-shadow-sm"><?php echo e($jumlahKandang ?? 0); ?></div>
            ...
            <div class="bg-gradient-to-br from-yellow-500 to-orange-600 text-white rounded-2xl shadow-xl p-6 
                ...
                <div>
                    <div class="text-4xl font-extrabold drop-shadow-sm"><?php echo e($jumlahAktivitas ?? 0); ?></div>
...
<script>
    ...
    $('#kategoriSelect').on('change', function() {
        ...
        $.post("<?php echo e(route('dashboard.filter')); ?>", {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ternakpro2\resources\views/dashboard.blade.php ENDPATH**/ ?>