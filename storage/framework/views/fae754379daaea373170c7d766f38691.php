...
    </div>
    ...
    <div class="flex justify-start mb-4">
        <a href="<?php echo e(route('penjualan_ternak.create')); ?>"
        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="hover:bg-blue-50 transition">
                    ...
                    <td class="border px-3 py-2 text-center"><?php echo e($item->tanggal); ?></td>
                    <td class="border px-3 py-2 text-center">Rp <?php echo e(number_format($item->harga_jual, 0, ',', '.')); ?></td>
                    <td class="border px-3 py-2 text-center"><?php echo e($item->ternak->id_ternak ?? '-'); ?> - <?php echo e($item->ternak->jenis ?? '-'); ?></td>
                    <td class="border px-3 py-2 text-center"><?php echo e($item->pelanggan->nama ?? '-'); ?></td>
                    <td class="border px-3 py-2 text-center flex justify-center gap-2">
                        
                        <a href="<?php echo e(route('penjualan_ternak.edit', $item->id)); ?>"
                        ...
                        <form action="<?php echo e(route('penjualan_ternak.destroy', $item->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ternakpro2\resources\views/penjualan_ternak/index.blade.php ENDPATH**/ ?>